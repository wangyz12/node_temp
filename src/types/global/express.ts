...
export type AsyncController = (req: ExpressRequest, res: ExpressResponse, next: ExpressNext) => Promise<any>;

// 可以继续添加其他Express相关类型
export type Middleware = (req: ExpressRequest, res: ExpressResponse, next: ExpressNext) => void;

export type ErrorMiddleware = (err: any, req: ExpressRequest, res: ExpressResponse, next: ExpressNext) => void;
