...
// 注册
router.post('/register', vaiedation.userViedation.registerVie.register, utils.handleValidationErrors, controller.userController.register);
// 登录
router.post('/login', vaiedation.userViedation.registerVie.register, utils.handleValidationErrors, controller.userController.login);
// 修改密码
