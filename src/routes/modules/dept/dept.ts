...
// 更新部门
router.put('/update/:id', checkPermission(systemPermissions.dept.edit), controller.deptController.updateDept);

// 删除部门
router.delete('/delete/:id', checkPermission(systemPermissions.dept.remove), controller.deptController.deleteDept);

// 获取部门用户统计
router.get('/stats', checkPermission(systemPermissions.dept.list), controller.deptController.getDeptUserStats);
